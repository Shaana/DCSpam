...
config["default"] = {
  ...
  ["spam_msg"] = "{r1} Deposit Coin (1/7 Mythic) is recruiting dps and exceptional players for progress. We raid 2 times per week 19:30 - 23:00. We consist of previous top players on the server who now want to raid more casually. /w for more information.",
